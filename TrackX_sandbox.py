...
particle_states = [
    ...
    # particle_state(Ptype='Proton', position=[200, 40, 0], tx=0, ty=0, momentum=[0, 0, 0.9 * p_mass], charge=p_charge),
...
def select_sim_type(sim_type,num_steps):
    if sim_type == 'dt':
        ...
        RK4_simulate_particles_dz(particle_states, LHCbField, 1400/num_steps, 0, num_steps)
    else:
